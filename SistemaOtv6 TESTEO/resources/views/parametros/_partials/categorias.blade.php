<details id="categorias-section" style="width: 100%; margin-bottom: 10px;">
    <summary
    ...
    <div class="d-flex justify-content-between align-items-center mt-3">
        ...
        <div>
            {{ $categorias->appends(['search' => request('search')])->links('pagination::bootstrap-5') }}
        </div>

        <!-- Texto "Showing" alineado a la derecha -->
        <div>
            <p class="text-muted">
