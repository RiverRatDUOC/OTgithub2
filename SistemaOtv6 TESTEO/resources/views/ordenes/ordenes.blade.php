                        ...
                        @foreach ($ordenes as $orden)
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <a href="#" style="color: #cc6633;" data-bs-toggle="modal"
                                ...
                                <td>{{ html_entity_decode($orden->servicio->nombre_servicio) }}</td>
                                <td>{{ html_entity_decode($orden->tecnicoEncargado->nombre_tecnico) }}</td>
                                <td>{{ $orden->estado->descripcion_estado_ot }}</td>
                                <td style="width:10%">{{ date('d-m-Y', strtotime($orden->created_at)) }}</td>
                                {{-- <td>{{ $orden->cotizacion }}</td> --}}
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('ordenes.show', $orden->numero_ot) }}"
                                        ...
                                        <a href="{{ route('ordenes.edit', $orden->numero_ot) }}"
                                            class="btn btn-primary me-1"
                                            style="background-color: #cc6633; border-color: #cc6633;">
                ...
                @if ($ordenes->hasPages())
                    <nav>
                        <ul class="pagination" style="color: #cc6633;">
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link" href="{{ $ordenes->url(1) }}" rel="prev"
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link" href="{{ $ordenes->previousPageUrl() }}" rel="prev"
                            ...
                            @if ($ordenes->hasMorePages())
                                <li class="page-item">
                                    <a class="page-link" href="{{ $ordenes->nextPageUrl() }}" rel="next"
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link" href="{{ $ordenes->url($ordenes->lastPage()) }}" rel="next"
