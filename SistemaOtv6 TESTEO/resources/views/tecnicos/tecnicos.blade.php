            ...
            <div class="col">
                <div class="d-flex justify-content-between align-items-center text-center mt-3">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="{{ route('tecnicos.create') }}" class="btn btn-primary ms-auto" style="background-color: #cc6633; border-color: #cc6633;">
                ...
                <div class="d-flex justify-content-center mt-4">
                    ...
                    <nav>
                        <ul class="pagination" style="color: #cc6633;">
                            ...
                            @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $tecnicos->url(1) }}" rel="prev" style="color: #cc6633;">&laquo;</a>
                            </li>
                            @endif
                            ...
                            @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $tecnicos->previousPageUrl() }}" rel="prev" style="color: #cc6633;">&lsaquo;</a>
                            </li>
                            @endif
                            ...
                            <li class="page-item">
                                <a class="page-link" href="{{ $tecnicos->nextPageUrl() }}" rel="next" style="color: #cc6633;">&rsaquo;</a>
                            </li>
                            @else
                            <li class="page-item disabled" aria-disabled="true">
                            ...
                            @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $tecnicos->url($tecnicos->lastPage()) }}" rel="next" style="color: #cc6633;">&raquo;</a>
                            </li>
                            @endif
                        </ul>
                    </nav>
