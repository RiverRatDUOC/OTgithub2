    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark flex-md-column flex-row align-items-start py-2"
        ...
        <div class="collapse navbar-collapse">
            <ul class="flex-md-column flex-row navbar-nav w-100 justify-content-between"
                ...
                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('sucursales*') ? 'active' : '' }}"
                        href="{{ route('sucursales.index') }}">
                        <i class="fas fa-building"></i> <span>Sucursales</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('contactos*') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('servicios*') ? 'active' : '' }}"
                        href="{{ route('servicios.index') }}">
                        <i class="fas fa-concierge-bell"></i> <span>Servicios</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('tareas*') ? 'active' : '' }}"
                        href="{{ route('tareas.index') }}">
                        <i class="fas fa-tasks"></i> <span>Tareas</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('tecnicos*') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('convenios*') ? 'active' : '' }}"
                        href="#"><i class="fas fa-handshake"></i> <span>Convenios</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('repuestos*') ? 'active' : '' }}"
                        href="#"><i class="fas fa-tools"></i> <span>Repuestos</span></a>
                </li>

                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('modelos*') ? 'active' : '' }}"
                        href="{{ route('modelos.index') }}">
                        <i class="fas fa-desktop"></i> <span>Modelos</span></a>
                </li>

                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('dispositivos*') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('parametros*') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('reclamos*') ? 'active' : '' }}"
                        href="#"><i class="fas fa-exclamation-triangle"></i> <span>Reclamos</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('seguimiento*') ? 'active' : '' }}"
                        href="#"><i class="fas fa-binoculars"></i> <span>Seguimiento</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('agendamiento*') ? 'active' : '' }}"
                        href="#"><i class="fas fa-calendar-alt"></i> <span>Agendamiento</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('contrato*') ? 'active' : '' }}"
                        href="#"><i class="fas fa-file-contract"></i> <span>Contrato</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('roles*') ? 'active' : '' }}"
                        href="{{ route('roles.index') }}">
                        <i class="fas fa-user-shield"></i> <span>Roles</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link pl-0 text-white {{ Request::is('usuarios*') ? 'active' : '' }}"
